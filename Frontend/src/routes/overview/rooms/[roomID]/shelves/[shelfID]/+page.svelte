...
>
  <div class="flex flex-col mt-10 mb-4 text-center">
    <div class="text-4xl font-bold text-gray-900">Items für {shelf.Name}</div>
  </div>
            ...
            {#each showItems as item (item.ID)}
              ...
              >
                ...
                <td class="px-6 py-4 text-center"
                  >{#if item.UsersBorrowed && item.Quantity === 0}
